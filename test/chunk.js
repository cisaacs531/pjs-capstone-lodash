...
assert.equals(TEST_NAME, 'Returns an array', '_.chunk([1, 2, 3, 4], 2)',
...
assert.arrayEquals(TEST_NAME, 'Chunks evenly-divided arrays', '_.chunk([1, 2, 3, 4], 2)',
 _.chunk([1, 2, 3, 4], 2), [[1, 2], [3, 4]]);

assert.arrayEquals(TEST_NAME, 'Chunks unevenly-divided arrays', '_.chunk([1, 2, 3, 4, 5], 2)',
